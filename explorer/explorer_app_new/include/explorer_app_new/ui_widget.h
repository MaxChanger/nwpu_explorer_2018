...
public:
    ...
    void setupUi(QWidget *Widget) {
        ...
        }
        {
            ...
            gridLayoutWidget_2->setGeometry(QRect(30, 200, 128, 111));
            ...
            gridLayout_2->setContentsMargins(0, 0, 0, 0);
            {
                ...
                gridLayout_2->addWidget(env_t_lable, 1, 0, 1, 1);
                ...
                gridLayout_2->addWidget(env_t_num_show, 1, 1, 1, 2);
                ...
                font2.setBold(true);
                font2.setWeight(75);
                aim_t_lable->setFont(font2);
                gridLayout_2->addWidget(aim_t_lable, 2, 0, 1, 1);
                ...
                gridLayout_2->addWidget(aim_t_num_show, 2, 1, 1, 2);
            }
        }
    ...
    void retranslateUi(QWidget *Widget) {
        ...
        aim_t_lable->setText(QApplication::translate("Widget","aim_t", 0, QApplication::UnicodeUTF8));
        env_t_lable->setText(QApplication::translate("Widget","env_t", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
