...
int main(int argc, char **argv)
{
  ...
  // MoveIt!通过名为“planning groups”的关节组运作，并把他们储存在`JointModelGroup`. "planning group" 和 "joint model group"是一样的。
  static const std::string PLANNING_GROUP = "right_arm";

  // 使用movegroup接口类`MoveGroup` 只需要你改写想控制规划的规划组
  moveit::planning_interface::MoveGroupInterface move_group(PLANNING_GROUP);

  // 我们可以使用the :planning_scene_interface:`PlanningSceneInterface`类在“virtual world”场景添加或去除障碍物
  ...
  // and report success on execution of a trajectory.-----------------什么意思？？？？？？？
  ...
  success = (move_group.plan(my_plan) != moveit::planning_interface::MoveItErrorCode(move_action_client_->getResult()->error_code));
